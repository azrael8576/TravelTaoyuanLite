...
import com.wei.traveltaoyuanlite.core.util.TestNetworkMonitor
import com.wei.traveltaoyuanlite.utilities.COMPACT_HEIGHT
import com.wei.traveltaoyuanlite.utilities.COMPACT_WIDTH
import com.wei.traveltaoyuanlite.utilities.EXPANDED_HEIGHT
import com.wei.traveltaoyuanlite.utilities.EXPANDED_WIDTH
import com.wei.traveltaoyuanlite.utilities.FoldingDeviceUtil
import com.wei.traveltaoyuanlite.utilities.MEDIUM_HEIGHT
import com.wei.traveltaoyuanlite.utilities.MEDIUM_WIDTH
...
class TtlAppStateTest {
    ...
    // Subject under test.
    private lateinit var state: TtlAppState
    ...
    fun verifyTopLevelDestinationsContainExpectedNames() = runTest {
        ...
        assertThat(state.topLevelDestinations[1].name).ignoringCase().contains("attraction")
    }
    ...
    fun verifyBottomNavigationDisplayed_whenWindowSizeIsCompact() = runTest {
        composeTestRule.setContent {
            ...
            assertThat(state.navigationType).isEqualTo(TtlNavigationType.BOTTOM_NAVIGATION)
        }
    }
    ...
    fun verifyNavigationRailDisplayed_whenWindowSizeIsMedium() = runTest {
        composeTestRule.setContent {
            ...
            assertThat(state.navigationType).isEqualTo(TtlNavigationType.NAVIGATION_RAIL)
        }
    }
    ...
    fun verifyPermanentNavDrawerDisplayed_whenWindowSizeIsExpanded() = runTest {
        composeTestRule.setContent {
            ...
            assertThat(state.navigationType).isEqualTo(TtlNavigationType.PERMANENT_NAVIGATION_DRAWER)
        }
    }
    ...
    fun verifyContentTypeIsSINGLE_PANE_whenWindowSizeIsCompact() = runTest {
        composeTestRule.setContent {
            ...
            assertThat(state.contentType).isEqualTo(TtlContentType.SINGLE_PANE)
        }
    }
    ...
    fun verifyContentTypeIsDUAL_PANE_whenWindowSizeIsMedium_withBookPosture() = runTest {
        composeTestRule.setContent {
            ...
            assertThat(state.contentType).isEqualTo(TtlContentType.DUAL_PANE)
        }
    }
